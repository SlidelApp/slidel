...
class KeystoneCorrection:
    ...
    def calculate_transformation_coefficients(self, x0, y0, x1, y1, x2, y2, x3, y3):
        delta_x0 = x0 - x2
        delta_x1 = x1 - x2
        delta_y0 = y0 - y2
        delta_y1 = y1 - y2
    ...
    def keystone_correction(
        ...
        a, b, c, d, e, f, g, h = self.calculate_transformation_coefficients(
...
#     keystone = KeystoneCorrection("VID_20240226_123808.mp4")
#     keystone.process_video()
